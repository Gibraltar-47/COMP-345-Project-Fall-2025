...
void testOrderExecution(){
    ...
    // p2->getOrderList()->add(iorder1);
    // p2->getOrderList()->add(iorder2);
    // p2->getOrderList()->add(iorder3);
    // p2->getOrderList()->add(iorder4);
    ...
    // cout << "\n";
    // int p2orderlistsize = p2->getOrderList()->getList().size();
    // cout << "SIZE OF P2 LIST: " << p2orderlistsize << endl;
    // // Clear the list of invalid orders and deallocate them for p2
    // for (int i = 0; i < p2orderlistsize; i++){
    //     Orders* o = p2->getOrderList()->remove(0);
    //     delete o;
    // }

    // cout << "HERE IS THE p2 LIST OF ORDERS NOW" << endl;
    // // Using range-based for loop
    // for (auto elem : p2->getOrderList()->getList()) {
    //     cout << *elem << "\n";
    // }
    // cout << endl;
