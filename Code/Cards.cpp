...
void Card::play(Deck& deck, Hand* hand, OrdersList& olist) {  //Orderlist requires changing it to the right name

    //creates order and adds it to the orderlist of the PLAYER***************************************************
    olist.add(new OrdersBlockade()); //Name of the order<<=============================================
    //^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
void Hand::playCard(Deck& deck, const string& cardName, OrdersList& olist) { //DO NOT REMOVE THIS PART FOR ASSIGNMENT 1 (but will need to change for second assignment)
    //Plays a card
